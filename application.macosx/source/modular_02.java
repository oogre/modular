...
interface ControlListener {
	...
	public void tap3Event(String s, boolean b);
}
...
class Osc implements ControlListener{
		...
		if (cbxActive1.isSelected()) {
			...
			for (int x = 0; x < i.width; x ++) {
				...
				for (int y = 0; y < i.height; y ++) {
					...
					o+= m;
					float V  = invert ? 1 - this.getValue() : this.getValue();
					int n = x  + (y+ PApplet.parseInt(o)) * i.width;
	...
	public void tap3Event(String name,boolean state){}
}
class Translator {
